...
<section class="scene cth scheme-04" id="contato" data-scene data-tone="dark" aria-labelledby="contato-titulo">
  ...
  <div class="scene__body">
    ...
    <p class="cth__lead rise" data-d="2">Seja para <strong>agendar uma consulta</strong>, tirar uma dúvida ou simplesmente conhecer melhor o meu trabalho. Estou aqui. Entre em contato pelo canal que for mais confortável para você.</p>
...
<section class="scene ctf scheme-05" id="mensagem" data-scene data-tone="light" aria-labelledby="mensagem-titulo">
  <div class="scene__body">
    <div class="ctf__lado">
      ...
      <p class="ctf__lead rise" data-d="1">Conte em poucas linhas o que precisa. Sua mensagem fica registrada e chega diretamente para a nossa equipe de atendimento.</p>

      <ol class="ctf__passos rise" data-d="2">
        <li class="ctf__passo">
          <span class="ctf__n">01</span>
          <div><strong>Você envia a sua mensagem</strong><p>Preencha seu nome e e-mail e diga o assunto na mensagem. Informe também seu WhatsApp para facilitar o retorno.</p></div>
        </li>
        <li class="ctf__passo">
          <span class="ctf__n">02</span>
          <div><strong>A equipe recebe</strong><p>Sua mensagem é recebida e encaminhada internamente para que o retorno seja feito da forma mais adequada.</p></div>
        </li>
        <li class="ctf__passo">
          <span class="ctf__n">03</span>
          <div><strong>Retornamos em até 1 dia útil</strong><p>Você receberá uma resposta pelo contato informado. Para questões urgentes, faça contato diretamente pelo WhatsApp.</p></div>
        </li>
      </ol>

      <p class="ctf__aviso rise" data-d="3"><i class="ph ph-shield-check" aria-hidden="true"></i><span><strong>Importante.</strong> Este canal é destinado a dúvidas sobre consultas, agendamentos e atendimento. <strong>Não envie sintomas, exames ou informações clínicas por aqui.</strong> Questões de saúde devem ser avaliadas em consulta.</span></p>
    </div>
