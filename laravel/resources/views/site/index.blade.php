...
<section class="scene about scheme-05" id="sobre" data-scene data-tone="light" aria-labelledby="sobre-titulo">
  <div class="scene__body">
    <figure class="about__photo rise rise--left">
      <img src="assets/img/imagem-010.webp" alt="Dra. Marina Mariz sorrindo à mesa do consultório" width="1254" height="1254" loading="lazy" style="object-position:0 20%">
    ...
    <div class="about__copy">
      ...
      <h2 class="t-h2 rise" data-d="1" id="sobre-titulo">Eu conheço a gestação de dois lugares:<br>de quem cuida e de quem precisou ser cuidada</h2>
      <!-- texto: Escopo das Páginas/Sobre.md, seção 1 -->
      <p class="lead rise" data-d="2">Minha trajetória foi moldada tanto pela <strong>ciência</strong> quanto pela <strong>experiência pessoal</strong> de ser mãe. <br class="br-desk">Esses dois mundos se encontram em cada atendimento que realizo.</p>
      ...
      <p class="rise" data-d="3" style="color:var(--text-muted)">Formada em <strong>medicina pela UFMG</strong>, com residência em <strong>obstetrícia</strong> e <strong>medicina fetal</strong>, carrego na prática clínica <strong>a memória de todas as mulheres que me ensinaram</strong> o que é gestar com medo — e com esperança.</p>
...
<section class="scene spec scheme-04" id="especialidades" data-scene data-tone="dark" aria-labelledby="esp-titulo">
  <div class="scene__body">
    <header class="spec__head">
      ...
      <h2 class="t-h2 rise" data-d="1" id="esp-titulo">Especialização técnica aliada a um<br>cuidado profundamente humano</h2>
    </header>
    <ul class="spec__list"><li class="spec__row rise" data-d="1"><button class="spec__btn" type="button" aria-expanded="false" aria-controls="esp-1"><span class="spec__num">01</span><span class="spec__name">Pré-concepção</span><i class="ph ph-plus" aria-hidden="true"></i></button><div class="spec__panel" id="esp-1"><div><p><strong>Avaliação da saúde</strong>, histórico e fatores de risco antes da gestação. Preparo individualizado para <strong>engravidar com mais segurança</strong>.</p></div></div></li><li class="spec__row rise" data-d="2"><button class="spec__btn" type="button" aria-expanded="false" aria-controls="esp-2"><span class="spec__num">02</span><span class="spec__name">Pré-natal</span><i class="ph ph-plus" aria-hidden="true"></i></button><div class="spec__panel" id="esp-2"><div><p>Acompanhamento da <strong>evolução da gestação</strong> e da saúde materno-fetal. Escuta, orientação e <strong>decisões seguras</strong> em cada fase.</p></div></div></li><li class="spec__row rise" data-d="3"><button class="spec__btn" type="button" aria-expanded="false" aria-controls="esp-3"><span class="spec__num">03</span><span class="spec__name">Gestação de Alto Risco</span><i class="ph ph-plus" aria-hidden="true"></i></button><div class="spec__panel" id="esp-3"><div><p><strong>Vigilância ampliada</strong>, planejamento e condutas bem definidas. Cuidado <strong>individualizado</strong> para mãe e bebê.</p></div></div></li><li class="spec__row rise" data-d="4"><button class="spec__btn" type="button" aria-expanded="false" aria-controls="esp-4"><span class="spec__num">04</span><span class="spec__name">Medicina Fetal</span><i class="ph ph-plus" aria-hidden="true"></i></button><div class="spec__panel" id="esp-4"><div><p>Avaliação da saúde e do <strong>desenvolvimento do bebê</strong>. Diagnóstico, monitoramento e <strong>orientação com clareza</strong>.</p></div></div></li><li class="spec__row rise" data-d="5"><button class="spec__btn" type="button" aria-expanded="false" aria-controls="esp-5"><span class="spec__num">05</span><span class="spec__name">Assistência Personalizada</span><i class="ph ph-plus" aria-hidden="true"></i></button><div class="spec__panel" id="esp-5"><div><p>Acompanhamento contínuo <strong>do positivo ao pós-parto</strong>. Apoio, orientação e <strong>presença da equipe</strong> em cada fase.</p></div></div></li><li class="spec__row rise" data-d="6"><button class="spec__btn" type="button" aria-expanded="false" aria-controls="esp-6"><span class="spec__num">06</span><span class="spec__name">Parto Humanizado</span><i class="ph ph-plus" aria-hidden="true"></i></button><div class="spec__panel" id="esp-6"><div><p><strong>Respeito, informação e participação</strong> da mulher nas decisões. Escuta, consentimento e <strong>segurança</strong> em todo o processo.</p></div></div></li></ul>
...
<section class="scene team scheme-05" id="amara" data-scene data-tone="light" aria-labelledby="amara-titulo">
  <div class="scene__body">
    <div class="team__copy">
      ...
      <h2 class="t-h2 rise" data-d="1" id="amara-titulo">Amara:<br>a força do coletivo</h2>
      <div class="team__card rise rise--zoom" data-d="1"><svg class="team__card__logo" viewBox="0 0 478.13 87.45" aria-hidden="true"><use href="#amara-logo-simples"></use></svg><p>Marina é Cofundadora da Amara.</p></div>
      <!-- texto: Escopo das Páginas/Amara.md, seção 2 -->
      <p class="lead rise" data-d="2">Um núcleo de <strong>Obstetrícia</strong> que atua ao lado de uma <strong>equipe multidisciplinar completa</strong>.</p>
      <p class="rise" data-d="3" style="color:var(--text-muted)">Unidas não apenas pela <strong>excelência técnica</strong>, mas por uma <strong>filosofia de prática compartilhada</strong>, as decisões são tomadas <strong>em conjunto</strong>. A comunicação é <strong>fluida</strong>. E a paciente tem acesso a uma <strong>assistência completa e robusta</strong>.</p>
    ...
    <div class="team__frame rise rise--right" data-d="2" aria-hidden="true"><img src="assets/img/imagem-011.webp" alt="" width="2174" height="1450" loading="lazy" decoding="async"><img src="assets/img/imagem-012.webp" alt="" width="1200" height="1600" loading="lazy" decoding="async"><img src="assets/img/imagem-013.webp" alt="" width="960" height="1280" loading="lazy" decoding="async" style="object-position:50% 0"><img src="assets/img/imagem-014.webp" alt="" width="872" height="1280" loading="lazy" decoding="async" style="object-position:50% 0"><img src="assets/img/imagem-007.webp" alt="" width="1135" height="1386" loading="lazy" decoding="async" style="object-position:50% 0"><svg class="team__seal" viewBox="0 0 149.31 148.64" aria-hidden="true"><use href="#amara-badge"></use></svg></div>
  </div>
</section>
...
<section class="scene blog scheme-04" id="blog" data-scene data-tone="dark" aria-labelledby="blog-titulo">
  <div class="scene__body">
    <header class="blog__head">
      ...
      <p class="lead rise" data-d="2"><strong>Artigos, informações e reflexões</strong> para maternar com mais <strong>clareza e segurança</strong>.</p>
    </header>
    {{-- Ultimos posts publicados, vindos do painel. Mesmo recorte do /blog.
         Cada linha leva ao post; sem post no ar a lista nao aparece. --}}
    @if ($ultimosPosts->isNotEmpty())
    <ul class="blog__list">@foreach ($ultimosPosts as $post)<li class="blog__row rise" data-d="{{ $loop->iteration }}"><a href="{{ route('site.blog.post', $post->slug) }}" target="_blank" rel="noopener"><span class="blog__cat">{{ $post->categoria?->name }}</span><span class="blog__title">{{ $post->title }}</span><span class="blog__date"><time datetime="{{ $post->published_at->format('Y-m-d') }}">{{ ucfirst($post->published_at->translatedFormat('M Y')) }}</time></span><i class="ph ph-arrow-up-right" aria-hidden="true"></i></a></li>@endforeach</ul>
    @endif
