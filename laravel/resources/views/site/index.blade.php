...
<section class="scene about scheme-05" id="sobre" data-scene data-tone="light" aria-labelledby="sobre-titulo">
  <div class="scene__body">
    ...
    <div class="about__copy">
      ...
      <p class="lead rise" data-d="2">Minha carreira foi moldada tanto pela <strong>ciência</strong> quanto pela <strong>experiência pessoal</strong> de ser mãe. <br class="br-desk">Esses dois mundos se encontram em cada atendimento que realizo.</p>
      ...
      <p class="rise" data-d="3" style="color:var(--text-muted)">Formada em <strong>medicina pela UFMG</strong>, com residência em <strong>obstetrícia</strong> e especialização em <strong>medicina fetal</strong>, minha prática clínica se apoia na ciência, na atenção às particularidades de cada gestação e na compreensão de que toda conduta deve sempre considerar a mulher, sua história, seu contexto e suas escolhas.</p>
