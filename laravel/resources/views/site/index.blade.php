...
<section class="scene team scheme-05" id="amara" data-scene data-tone="light" aria-labelledby="amara-titulo">
  <div class="scene__body">
    <div class="team__copy">
      ...
      <div class="team__card rise rise--zoom" data-d="1"><svg class="team__card__logo" viewBox="0 0 478.13 87.45" aria-hidden="true"><use href="#amara-logo-simples"></use></svg><p>A Dra. Marina Mariz faz parte da Amara</p></div>
