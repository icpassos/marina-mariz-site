...
<section class="scene esph scheme-04" id="apresentacao" data-scene data-tone="dark" aria-labelledby="esp-titulo">
  ...
  <div class="scene__body">
    <div class="esph__copy">
      ...
      <p class="lead rise" data-d="3">Ginecologia, obstetrícia e medicina fetal integradas em um acompanhamento contínuo, atento às mudanças de cada fase e às necessidades de cada mulher. Minha atuação é sustentada por um padrão reconhecível: avaliação criteriosa, orientações baseadas em evidências, comunicação clara e espaço seguro para falar, perguntar e decidir.</p>
...
<section class="scene tri scheme-05" id="areas" data-scene data-tone="light" aria-labelledby="areas-titulo">
  <div class="scene__body">
    <header class="sec__head sec__head--mid">
      ...
      <p class="lead rise" data-d="2">Cada fase pede uma condução própria. Mas, em todas elas, devem permanecer a ciência, a segurança, a informação clara e o respeito às escolhas da mulher.</p>
    </header>
    ...
    <ol class="tri__grid">
      <li class="rise rise--left" id="area-01" data-d="1"><article class="tri__card" data-glow>
        ...
        <div class="tri__body">
          <h3>Pré-concepção</h3>
          <p>O cuidado começa antes do teste positivo. Na consulta pré-concepcional, avaliamos sua saúde, seu histórico, exames, vacinas, medicamentos e possíveis fatores de risco para preparar o caminho para uma gestação mais segura.</p>
